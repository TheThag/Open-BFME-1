...
{
public:
	AsciiString openDataChunk(unsigned short *);
};

// ?openDataChunk@DataChunkInput@@QAE?AVAsciiString@@PAG@Z
__declspec(naked) AsciiString DataChunkInput::openDataChunk(unsigned short *)
{
	__asm {
		__emit 0x51
		__emit 0x56
