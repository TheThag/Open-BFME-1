...
// readable body of ?getDisallowAsianText@CustomMatchPreferences@@QAE_NXZ: Code/GameEngine/Source/Common/UserPreferences.cpp
// Lift the CustomMatchPreferences::getDisallowAsianText naked dump to clean C++.
//
...
bool CustomMatchPreferences::getDisallowAsianText(void)
{
	...
	if (_strcmpi(it->m_value.str(), "1") == 0)
	{
		return true;
	}
	return false;
