...
// TeamPrototype::hasAnyObjects, retail 0x000F7170, 61 bytes. Zero Hour's body
// with one BFME change: the question carries a flag, which is passed straight
// through to each team.  Player::hasAnyObjects at 0x000CE0B0 is the other half
// of that -- it forwards the same flag to every prototype through the thunk at
// 0x00021D96, which is this body.
//
