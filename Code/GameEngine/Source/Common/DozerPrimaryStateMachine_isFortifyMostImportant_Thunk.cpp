...
// the State +0x1C -> +0x10 -> +0x204 walk below. Retail's `sub eax, 2` pins DOZER_TASK_FORTIFY to 2.
//
...
bool __cdecl DozerPrimaryStateMachine::isFortifyMostImportant(State *thisState, void *)
{
	...
	return dozerAI->getMostRecentCommand() == DOZER_TASK_FORTIFY;
}
