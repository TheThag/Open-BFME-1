// cl: /DNDEBUG /MD /EHsc
// Open-BFME5: lift PoisonedBehavior ctor __emit thunk to clean C++.
// Retail: deep base ctor (out-of-line), UpdateModule's inline ctor stores the
// two interface subobjects' vtables at +0x0C/+0x10 and inits its three scalars;
// PoisonedBehavior's most-derived vtable batch, four member zeroings, then
