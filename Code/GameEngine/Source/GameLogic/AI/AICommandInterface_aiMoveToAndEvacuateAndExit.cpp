...
// stlport
// Open-BFME: AICommandInterface::aiMoveToAndEvacuateAndExit, retail 0x00152A00, 219 bytes.
//
// One of the reference's inline command builders, out of line here: build the
// parameter block, put the position in the coordinate slot at +0x08, then aiDoCommand at vtable slot 0.
//
...
//
// AICMD_MOVE_TO_POSITION_AND_EVACUATE_AND_EXIT is 0x04 in BFME's command list, which is the reference's
...
enum AICommandType { AICMD_MOVE_TO_POSITION_AND_EVACUATE_AND_EXIT = 0x04 };
