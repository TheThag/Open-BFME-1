...
// stlport
// Open-BFME: AICommandInterface::aiFollowExitProductionPath, retail 0x00165C30, 220 bytes.
//
// One of the reference's inline command builders, out of line here: build the
// parameter block, copy the caller's path into the coordinate vector at +0x20 and put the
// ignored object in the object slot, then
// aiDoCommand at vtable slot 0 -- the frame
// AICommandInterface_aiAttackObject.cpp measured.
//
// AICMD_FOLLOW_EXITPRODUCTION_PATH is 0x0A. BFME's command list is the reference's with the
...
enum AICommandType { AICMD_FOLLOW_EXITPRODUCTION_PATH = 0x0A };
