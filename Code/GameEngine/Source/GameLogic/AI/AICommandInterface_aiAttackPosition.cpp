...
// stlport
// Open-BFME: AICommandInterface::aiAttackPosition, retail 0x001539D0, 230 bytes.
//
// One of the reference's inline command builders, out of line here: build the
// parameter block, put the position in the coordinate slot and the shot limit in the misc integer, then
// aiDoCommand at vtable slot 0 -- the frame
// AICommandInterface_aiAttackObject.cpp measured.
//
// AICMD_ATTACK_POSITION is 0x0E. BFME's command list is the reference's with the
