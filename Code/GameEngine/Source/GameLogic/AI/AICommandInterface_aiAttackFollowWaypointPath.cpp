...
// stlport
// Open-BFME: AICommandInterface::aiAttackFollowWaypointPath, retail 0x00187540, 214 bytes.
//
...
//
// AICMD_ATTACKFOLLOW_WAYPOINT_PATH is 0x10. BFME's command list is the reference's with the
...
enum AICommandType { AICMD_ATTACKFOLLOW_WAYPOINT_PATH = 0x10 };
