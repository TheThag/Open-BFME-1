...
// stlport
// Open-BFME: AICommandInterface::aiAttackObject, retail 0x001535A0, 214 bytes.
//
// The reference's four lines, out of line here rather than inlined in the
// header, and the same command block its aiGetHealed sibling builds: the
// victim in the object slot, the shot limit in the misc integer, then
...
// member with anything to tear down, and the misc integer at +0x34.
//
// AICMD_ATTACK_OBJECT is 0x0B in BFME's command list.
...
enum AICommandType { AICMD_ATTACK_OBJECT = 0x0B };
