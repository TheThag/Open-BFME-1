...
// stlport
// Open-BFME: AICommandInterface::aiResumeConstruction, retail 0x00153E10, 203 bytes.
//
// One of the reference's inline command builders, out of line here: build the
// parameter block, put the object in the object slot, then
// aiDoCommand at vtable slot 0 -- the frame
// AICommandInterface_aiAttackObject.cpp measured.
//
// AICMD_RESUME_CONSTRUCTION is 0x14. BFME's command list is the reference's with the
...
enum AICommandType { AICMD_RESUME_CONSTRUCTION = 0x14 };
