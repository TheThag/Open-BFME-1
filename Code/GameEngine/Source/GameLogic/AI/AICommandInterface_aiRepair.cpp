...
// stlport
// Open-BFME: AICommandInterface::aiRepair, retail 0x00153D10, 203 bytes.
//
...
//
// AICMD_REPAIR is 0x13. BFME's command list is the reference's with the
...
enum AICommandType { AICMD_REPAIR = 0x13 };
