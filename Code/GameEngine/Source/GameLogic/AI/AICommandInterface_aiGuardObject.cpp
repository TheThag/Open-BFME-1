...
// stlport
// Open-BFME: AICommandInterface::aiGuardObject, retail 0x00154670, 214 bytes.
//
// One of the reference's inline command builders, out of line here: build the
// parameter block, put the object in the object slot and the guard mode in the misc integer, then
// aiDoCommand at vtable slot 0 -- the frame
// AICommandInterface_aiAttackObject.cpp measured.
//
// AICMD_GUARD_OBJECT is 0x1F. BFME's command list is the reference's with the
...
enum AICommandType { AICMD_GUARD_OBJECT = 0x1F };
