...
// stlport
// Open-BFME: AICommandInterface::aiGetRepaired, retail 0x00154010, 203 bytes.
//
// One of the reference's inline command builders, out of line here: build the
// parameter block, put the depot in the object slot, then
// aiDoCommand at vtable slot 0 -- the frame
// AICommandInterface_aiAttackObject.cpp measured.
//
// AICMD_GET_REPAIRED is 0x16. BFME's command list is the reference's with the
...
enum AICommandType { AICMD_GET_REPAIRED = 0x16 };
