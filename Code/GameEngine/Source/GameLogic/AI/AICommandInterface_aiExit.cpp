...
// stlport
// Open-BFME: AICommandInterface::aiExit, retail 0x00154330, 203 bytes.
//
...
//
// AICMD_EXIT is 0x1A. BFME's command list is the reference's with the
...
enum AICommandType { AICMD_EXIT = 0x1A };
