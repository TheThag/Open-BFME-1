...
// stlport
// Open-BFME: AICommandInterface::aiGuardPosition, retail 0x00154550, 230 bytes.
//
// One of the reference's inline command builders, out of line here: build the
// parameter block, put the position in the coordinate slot and the guard mode in the misc integer, then
// aiDoCommand at vtable slot 0 -- the frame
// AICommandInterface_aiAttackObject.cpp measured.
//
// AICMD_GUARD_POSITION is 0x1E. BFME's command list is the reference's with the
...
enum AICommandType { AICMD_GUARD_POSITION = 0x1E };
