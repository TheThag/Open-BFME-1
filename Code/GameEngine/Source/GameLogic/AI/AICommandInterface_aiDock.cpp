...
// stlport
// Open-BFME: AICommandInterface::aiDock, retail 0x00154110, 203 bytes.
//
...
//
// AICMD_DOCK is 0x18. BFME's command list is the reference's with the
...
enum AICommandType { AICMD_DOCK = 0x18 };
