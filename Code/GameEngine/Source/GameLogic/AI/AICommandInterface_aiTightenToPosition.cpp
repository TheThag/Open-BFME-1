...
// stlport
// Open-BFME: AICommandInterface::aiTightenToPosition, retail 0x001527C0, 219 bytes.
//
...
//
// AICMD_TIGHTEN_TO_POSITION is 0x02 in BFME's command list, which is the reference's
...
enum AICommandType { AICMD_TIGHTEN_TO_POSITION = 0x02 };
