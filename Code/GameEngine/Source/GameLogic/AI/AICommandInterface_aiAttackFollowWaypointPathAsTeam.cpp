...
// stlport
// Open-BFME: AICommandInterface::aiAttackFollowWaypointPathAsTeam, retail 0x00187650, 214 bytes.
//
// One of the reference's inline command builders, out of line here: build the
// parameter block, put the waypoint in the waypoint slot and the shot limit in the misc integer, then
// aiDoCommand at vtable slot 0 -- the frame
// AICommandInterface_aiAttackObject.cpp measured.
//
// AICMD_ATTACKFOLLOW_WAYPOINT_PATH_AS_TEAM is 0x11. BFME's command list is the reference's with the
...
enum AICommandType { AICMD_ATTACKFOLLOW_WAYPOINT_PATH_AS_TEAM = 0x11 };
